...
<div class="main-header">
    ...
    <p>Tác giả: Mai Văn Quân - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0349771722</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  <p>Tác giả: Mai Văn Quân - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0349771722</p></div>", unsafe_allow_html=True)
